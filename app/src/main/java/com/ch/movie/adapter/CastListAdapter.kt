...
class CastListAdapter(private var castList: ArrayList<Cast>, private var  thumbNailActions: ThumbNailActions): RecyclerView.Adapter<CastListAdapter.ViewHolder>() {
    ...
    fun pushToCastList(castList: Array<Cast>){
        for(cast in castList) {
            ...
            Log.i("response",cast.id.toString()+"|"+cast.name)
        }
